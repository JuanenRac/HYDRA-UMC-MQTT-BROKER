...
REM *****************************************************************************
REM Project   : HYDRA-UMC-MQTT-BROKER
...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-MQTT-BROKER - build.bat
...
echo ========================================
echo  Compiling HYDRA-UMC MQTT BROKER (Prod Mode)
echo ========================================
call npm run build
if errorlevel 1 (
  echo.
...
echo.
echo Build complete! You can now start the production broker with:
echo npm start
pause
